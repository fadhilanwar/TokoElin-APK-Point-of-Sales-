                        ...
                        <div class="row bg-">
                            ...
                            <div class="row mt-3">
                               <div class="col md-4">
                                   ...
                                   <a href="/cetakAllPenjualan" target="_blank"><button class="btn btn-success w-100">Cetak Keseluruhan</button></a>
                               </div>
                                ...
                                @foreach ($penjualan as $d)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                                ...
                                                <form  action="showDetail/{{ $d->no_transaksi }}" method="get">

                                                <button data-b-toggle="modal" data-b-target="#detail{{ $d->no_transaksi }}"
                                                    style="margin-right: 10px" class="btn btn-primary mr-2"><i
                                                    class="fa fa-edit"></i>Lihat Struk</button>
                                                </form>
